import '/models/lake/DestinationScreen.dart';
import '/models/screens/home_screen.dart';
import '/models/lake/Destination.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:animated_text_kit/animated_text_kit.dart';
import 'package:bangladesh_travel_app/models/New_tourist/home_screen2.dart';

class Homescreen_5 extends StatefulWidget {
  const Homescreen_5({Key? key}) : super(key: key);

  @override
  State<Homescreen_5> createState() => _Homescreen_5State();
}

class _Homescreen_5State extends State<Homescreen_5> {
